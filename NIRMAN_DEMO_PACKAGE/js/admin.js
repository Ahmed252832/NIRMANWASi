...
function renderDashboardPage() {
  ...
  for (index = 0; index < nirmanData.payments.length; index += 1) {
    ...
    deadlines.push({
      label: getClientName(nirmanData.payments[index].clientId) + " - Payment " + nirmanData.payments[index].paymentId,
      area: "Payment due",
  ...
  for (index = 0; index < nirmanData.tenderAwards.length; index += 1) {
    var awardedTender = getAdminTender(nirmanData.tenderAwards[index].tenderId);
    recentItems.push({ marker: "AW", title: "Tender award " + nirmanData.tenderAwards[index].awardId,
      note: (awardedTender ? awardedTender.title : "Tender") + " - Bid " + nirmanData.tenderAwards[index].bidId,
