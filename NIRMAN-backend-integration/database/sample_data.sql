INSERT ALL
    INTO Person (Person_id, First_Name, Last_Name, Contact_no, Email, Password, Profile_photo) VALUES ('P001', 'Arif', 'Rahman', '01711000001', 'arif@nirman.demo', '$2y$10$9iGWGyGSp0292cdZZ/JkQu4CFSgQ.PitvDlcTpjbUtAhUybN82/NW', 'images/profiles/employee-a.svg')
    INTO Person (Person_id, First_Name, Last_Name, Contact_no, Email, Password, Profile_photo) VALUES ('P002', 'Nusrat', 'Jahan', '01711000002', 'nusrat@nirman.demo', '$2y$10$x4MWWar2ZDkdKIlFMfuwW.2b/QwVMbAD9xaf.ffkH.8yrukjrtVxW', 'images/profiles/employee-b.svg')
    INTO Person (Person_id, First_Name, Last_Name, Contact_no, Email, Password, Profile_photo) VALUES ('P003', 'Farhan', 'Ahmed', '01711000003', 'farhan@nirman.demo', '$2y$10$WO2tJKQmUEhQZe0Yb6n5P.lDNthI8EMR/HqQkmIyaN5qU3Aj.7Xv2', 'images/profiles/employee-a.svg')
    INTO Person (Person_id, First_Name, Last_Name, Contact_no, Email, Password, Profile_photo) VALUES ('P004', 'Samira', 'Khan', '01812000001', 'samira@nirman.demo', '$2y$10$SOMbtxOPF3abWM6ft6CWgOwMVjKvigjUgp2iJCpdzfu2e/QmaDXFe', 'images/profiles/client.svg')
    INTO Person (Person_id, First_Name, Last_Name, Contact_no, Email, Password, Profile_photo) VALUES ('P005', 'Rafiul', 'Islam', '01812000002', 'rafiul@nirman.demo', '$2y$10$apMojgnq6z2Q.vQIB3zbHeEwRSNSgoW8Fh1Vm0dmSLWYhaaIjjUNq', 'images/profiles/client.svg')
    INTO Person (Person_id, First_Name, Last_Name, Contact_no, Email, Password, Profile_photo) VALUES ('P006', 'Tanvir', 'Hasan', '01913000001', 'tanvir@nirman.demo', '$2y$10$g4LFO66KyJoRIe06EEWc6Oc8O.0jVx4WN6vQDDkKhFA7KS7cXW.Tm', 'images/profiles/representative.svg')
    INTO Person (Person_id, First_Name, Last_Name, Contact_no, Email, Password, Profile_photo) VALUES ('P007', 'Mehedi', 'Chowdhury', '01913000002', 'mehedi@nirman.demo', '$2y$10$3qctExO2so8ztLmtqu08FeZcnjVdxivX6QjxSVQ4JXs3t7RXrAp5K', 'images/profiles/representative.svg')
    INTO Person (Person_id, First_Name, Last_Name, Contact_no, Email, Password, Profile_photo) VALUES ('P008', 'Sadia', 'Karim', '01711000004', 'sadia@nirman.demo', '$2y$10$J2XLEsdMzhTDAuGnVfbeuO/h7oqJe2A.AbkzYqyB2mz8Ts4oesWcy', 'images/profiles/employee-b.svg')
    INTO Person (Person_id, First_Name, Last_Name, Contact_no, Email, Password, Profile_photo) VALUES ('P009', 'Ayesha', 'Noor', '01812000003', 'ayesha@nirman.demo', '$2y$10$BpmAYzv.C/A6f61QmzKU9uFLxlPOEmlSiqxnTNlq3bc8LXYt3xZZO', 'images/profiles/client.svg')
    INTO Person (Person_id, First_Name, Last_Name, Contact_no, Email, Password, Profile_photo) VALUES ('P010', 'Imran', 'Hossain', '01913000003', 'imran@nirman.demo', '$2y$10$I.iBdhPGdJQCg7baS3y0hOuVC.DRGTKRbk9UZHGdwXIjBXbG8ZJgu', 'images/profiles/representative.svg')
    INTO Person (Person_id, First_Name, Last_Name, Contact_no, Email, Password, Profile_photo) VALUES ('P011', 'Faria', 'Sultana', '01913000004', 'faria@nirman.demo', '$2y$10$FNP8FwfdvcLnsTgyrBXWq.o8su6eGADX5opY4xj5TtRnBKSCrPP0u', 'images/profiles/representative.svg')
    INTO Person (Person_id, First_Name, Last_Name, Contact_no, Email, Password, Profile_photo) VALUES ('P012', 'Kabir', 'Miah', '01913000005', 'kabir@nirman.demo', '$2y$10$RvR285YlIa8RiNIxhr5iee62ec7f6vJL181sQlQrktY9NI/cfycAu', 'images/profiles/representative.svg')
    INTO Person (Person_id, First_Name, Last_Name, Contact_no, Email, Password, Profile_photo) VALUES ('P013', 'Maliha', 'Akter', '01812000004', 'maliha@nirman.demo', '$2y$10$Bw.XSv88U4So7sk94kIC1uswuNRroYkqP0qAqNEAjmQgNJsNnHJhm', 'images/profiles/client.svg')
    INTO Person (Person_id, First_Name, Last_Name, Contact_no, Email, Password, Profile_photo) VALUES ('P014', 'Omar', 'Faruk', '01812000005', 'omar@nirman.demo', '$2y$10$uW6MW9T4CJ1inSsfIRlaY.w0597lhRWOEEGGe8p1tuc.Cj81ky2jm', 'images/profiles/client.svg')
    INTO Person (Person_id, First_Name, Last_Name, Contact_no, Email, Password, Profile_photo) VALUES ('P015', 'Rumana', 'Haque', '01711000005', 'rumana@nirman.demo', '$2y$10$pES67223VbaNvfy1PLUUle5tUMM2Ff0MfANX6LMrSCph5eszRKzey', 'images/profiles/employee-b.svg')
    INTO Person (Person_id, First_Name, Last_Name, Contact_no, Email, Password, Profile_photo) VALUES ('P016', 'Shafiq', 'Alam', '01711000006', 'shafiq@nirman.demo', '$2y$10$7JrDjTm5tU.MJEIjkqTQEu2T4/4aiOVWFfDgtQnYs9yS1RDuLYAlK', 'images/profiles/employee-a.svg')
    INTO Person (Person_id, First_Name, Last_Name, Contact_no, Email, Password, Profile_photo) VALUES ('P017', 'System', 'Administrator', '01711000007', 'admin@nirman.demo', '$2y$10$o6SJB0lBKAMRbHaRZmlGpuaiqlVOnkLV9PI18WZU79X0mE07oq8M2', 'images/profiles/admin.svg')
SELECT 1 FROM DUAL;
...
INSERT ALL
    ...
    INTO Employee (Emp_id, Person_id, Dept_name, Designation, NID) VALUES ('E007', 'P017', 'Operations', 'System Administrator', 'NID-EMP-1007')
SELECT 1 FROM DUAL;
...
INSERT ALL
    INTO Tender_Bids (Tender_id, Bid_id, Rep_id, Bid_status, Bid_amount) VALUES ('T001', 'B001', 'R001', 'Rejected', 48500000)
